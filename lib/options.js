...
const optionDefinitions = [
	...
	},
	{
		...
		typeLabel: "string",
		description: "Extra options to forward to the API (format: 'option1=val1'). This parameter can be used multiple times.",
		type: String,
		multiple: true
	},
	{
...
function validateRemovebgOptions(removebgOptions) {
	...
	if (removebgOptions['skip-png-format-optimization']) {
		removebgOptions.format = 'png';
	} else {
